               ...
               <tbody>
                ...
                <tr class="p-3 mb-2 bg-light text-dark">
                  ...
                  <tr >
                     ...
                     <td class="text-left"><input type="text" class="form-control" style="width:150px" name="nwriter" value="wjsqudgns92" readonly></td>
                     <td></td>
                  </tr>
                  <tr>
                     <th >내용</th>
                  ...
                  <tr>
                     ...
                     <td colspan="3">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">취소</button></td>
                  </tr>
               </tbody>
            </table>
