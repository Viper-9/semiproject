      ...
      <div id="main">
         ...
         <br>
            <div class="card" style="width: 600px;" id="safetycard">
					<div class="card-body">
						<h3 class="card-title"><font style = "color:#ff6633"><b>Traveler's Couch 이용 방법</b></font></h3>
						<br>
						<p class="card-text">
						...
						<b>Traveler's Couch</b>은 여행자들을 커뮤니티에 연결시키는 서비스입니다.<br>
						<b>Traveler's Couch</b>을 사용하여 집이나 고향을 여행자들과 공유하거나 공유 할 장소를 <br>찾으십시오.<br>
						<b>Traveler's Couch</b>는 항상해야 할 일이 있고 만날 새로운 친구가 있도록 도와줍니다
						</font><br><br><br>
						<font style = "color:#ff6633; font-size: 15pt"><b>안전 기본 사항에 대해 읽기</b></font><br><br>
						<font style = "color:black; font-size: 10pt">
						사이트에서 제공하는 안전 기본 사항을 읽고 체크하십시오.<br>
						다른사람들과 커뮤니케이션 전 유의해야 될점에 <br>대해 명확하게 알려주고 있습니다. <br>
						당신은 안전 기본 사항을 읽지 않고 사이트를 제대로 이용할 수 없습니다. <br>
						<b>문제가 발생하지 않도록 꼭 읽고 확인하십시오.</b>				
						</font><br><br><br>
						<font style = "color:#ff6633; font-size: 15pt"><b>프로필 만들기</b></font><br><br>
						<font style = "color:black; font-size: 10pt">
						첫 번째 단계 <b>Traveler's Couch</b> 프로필을 완벽하게 작성하십시오! <br>
						이것은 당신을 소개할 수 있는 최초의 수단이 될 것이며,<br> 자신을 알려줄 수 있는 최초의 방법입니다 <br>
						세세한 프로필을 보유하는 것이 다른 사람들과 연결하는 가장 좋은 방법입니다.<br>
						작성된 프로필로 다른 사람에게 신뢰감을 심어주십시오.
						</font><br><br><br>						
						<font style = "color:#ff6633; font-size: 15pt"><b>친구 찾기</b></font><br><br>
						<font style = "color:black; font-size: 10pt">
						완벽한 프로필을 작성했다면, 가고 싶은 지역에 호스트,파트너,서퍼를 검색해보십오.<br>
						대화를 나누고싶은 상대의 프로필을 세세하게 확인해보십시오.<br>
						대상의 프로필에는 대상이 원하는 날짜, 대상의 평가지침이 될 수 있는 리뷰가 있습니다.
						동료를 찾았다면, 사이트에서 제공하는 대화기능으로 대화를 나누어 보십시오.
						</font><br><br><br>
						<font style = "color:#ff6633; font-size: 15pt"><b>친구가 되어주기</b></font><br><br>
						<font style = "color:black; font-size: 10pt">
						당신은 다른사람에게 호스팅,파트너를 요청할 수도 있지만,
						당신이 호스터 또는 <br>파트너로서 서퍼를 초대할 수도 있습니다.<br>
